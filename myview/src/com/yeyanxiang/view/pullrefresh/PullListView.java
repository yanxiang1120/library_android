...
public class PullListView extends ListView implements OnScrollListener {
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent = (RelativeLayout) mHeaderView
				.findViewById(resources.getIdentifier(
						"xlistview_header_content", "id", packagename));
		mHeaderTimeView = (TextView) mHeaderView.findViewById(resources
				...
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						if (mEnablePullRefresh) {
							ShowRefreshState(mHeaderViewHeight);
	...
	public void ShowRefreshState(int headerviewheight) {
		mHeaderView.setVisiableHeight(headerviewheight);
	...
	public void LoadMoreFinish(boolean finish) {
		if (mPullLoading == true) {
			mPullLoading = false;
			if (finish) {
				mFooterView.setState(PullListViewFooter.STATE_FINISH);
			} else {
				mFooterView.setState(PullListViewFooter.STATE_NORMAL);
			}
		}
	...
	public void setHeaderBg(int resid) {
