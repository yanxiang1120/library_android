 ...
 * @update 2014年3月13日
 * 
 * @简介 Detects transformation gestures involving more than one pointer
 *     ("multitouch") using the supplied {@link MotionEvent}s. The
 *     {@link OnScaleGestureListener} callback will notify users when a
 *     particular gesture event has occurred. This class should only be used
 *     with {@link MotionEvent}s reported via touch.
 * 
 *     To use this class:
 *     <ul>
