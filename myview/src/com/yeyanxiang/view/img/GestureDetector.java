 ...
 * @update 2014年3月13日
 * 
 * @简介 Detects various gestures and events using the supplied
 *     {@link MotionEvent}s. The {@link OnGestureListener} callback will notify
 *     users when a particular motion event has occurred. This class should only
 *     be used with {@link MotionEvent}s reported via touch (don't use for
 *     trackball events).
 * 
 *     To use this class:
 *     <ul>
 *     <li>Create an instance of the {@code GestureDetector} for your
 *     {@link View}
