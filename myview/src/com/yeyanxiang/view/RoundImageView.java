 ...
 * @update 2014年5月29日
 * 
 * @简介 It override ImageView's onDraw , so , some ImageView's origin function
 *     can not work: 1. DrawMatrix is disabled 2. CropToPadding is useless 3. It
 *     will be always work in CenterCrop mode!!!!!!
 */
public class RoundImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		// android.graphics.drawable.TransitionDrawable cannot be cast
